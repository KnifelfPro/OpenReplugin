...
class XmlHandler extends DefaultHandler {
    ...
    public void startElement(String uri, String localName, String qName, Attributes attributes) throws SAXException {
        ...
        switch (qName) {
            ...
            case "receiver":
                ...
                curComponent.intentFilters = filters;
                curComponent.name = repairAttrName(attributes.getValue("android:name"));
                curComponent.exported = parseExported(attributes);
                break;
     ...
     */
    private static Boolean parseExported(Attributes attributes) {
        String exported = attributes.getValue("android:exported");
        if (exported == null) {
            exported = attributes.getValue("exported");
        }
        if ("true".equalsIgnoreCase(exported)) {
            return Boolean.TRUE;
        }
        if ("false".equalsIgnoreCase(exported)) {
