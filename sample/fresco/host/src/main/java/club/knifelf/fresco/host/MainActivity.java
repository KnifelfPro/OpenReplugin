package club.knifelf.fresco.host;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void openPlugin() {
        boolean ok = RePlugin.startActivity(this,
                RePlugin.createIntent("fresco", "club.knifelf.fresco.plugin.MainActivity"));
        if (!ok) {
            Toast.makeText(this, "plugin fresco not installed", Toast.LENGTH_LONG).show();
        }
    }
}
