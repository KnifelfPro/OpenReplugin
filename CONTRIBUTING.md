欢迎关注和使用 OpenReplugin。为了让解决问题、贡献代码的效率更高，请务必按照下面流程来做。
...
> 出于效率考虑，请**务必按照 Issue模板 所列来完整的填写反馈**（我们已自动帮您建立模板，您在写新Issue时会有，也可以[点击此处查看模板内容](./.github/ISSUE_TEMPLATE.md)）
> 
> 注意：**未按照模板填写，且不能帮助我们定位问题的，我们将其标记为“Invalid”，并直接关闭，不会进一步问询。直到按照完整模板填写后，再行Reopen**。
> 
> 此外，我们都希望提出的问题是**“高质量的”**，详细描述背景、复现步骤和预期行为，帮助更快的解决您遇到的问题。

#### 如果是意见和建议

我们的Issue模板只针对“问题反馈”而设计。而若您在 OpenReplugin 中有一些新的想法想讨论的话，可“无需按照Issue模板”来提，但请留意：
...
当然，和Issue相比，我们非常欢迎您研究 OpenReplugin 的源码，发现相应的问题和改善方案，并提交自己的Pull Request。**高质量的PR将有助于打造自己的技术品牌，好处很多**。

在提出Pull Request之前，**建议请先提下Issue，这样可以在编写代码前，和大家做较为充分的讨论**，以免在后期出现“大量修改”的情况。

> 提交前请确保代码风格与现有代码保持一致，并附上必要的说明，方便 Review。
